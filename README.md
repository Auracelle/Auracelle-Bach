...
1. Open the notebook: `CHIA_PERFECT_02_09_26_AURACELLE_BACH_3_D_BEHAVIOR_AND_COGNITIVE_INTEGRATED.ipynb`
2. Run the single cell — all dependencies install automatically
3. Enter ngrok auth token when prompted
4. Access at: `https://graceaevans-auracelle-ailabs.ngrok.app`
5. Password: `charlie2025`
...
@software{evans2026auracelle_bach,
  ...
  url       = {https://github.com/graceaevans/auracelle-bach}
}
```
